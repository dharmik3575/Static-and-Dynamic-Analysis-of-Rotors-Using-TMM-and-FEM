...
E = 2.1e+11;
d = 0.01;        %shaft dia
rho = 7800;        %shaft density

md1 = 2; % in kg
Id1 = 0.01; %md1*D1^2/15; % in kg-m^2

md2 = 2;
Id2 = 0.01;

mass = [1   md1   Id1;
        2   md2   Id2];  %1st column node 2nd colum mass 3rd column Id
...
bc_data = [1, 1;     % First Column is Node number
           2, 1];     % Second column is prescribed local dof
...
legend('show');
hold on
saveas(h,'Ch9_Q14_FEM','png');

% print solution
fid = fopen('Ch9_Q14_FEM.txt','w');
