...
Ip = 0.02; % Polar Mass Moment of Inertia of the Disc

%% Elements and Nodes

nele = 6; % No. of Elements
% As disc is taken at mid-span in 2nd case, it is preferable to take even number of elements.
...
for i = 1:nele
    ...
    elseif(bc(p) == 2 && i == (nele/2 + 1))
        m_ele(:,:,i) = [Ip, 0; 0, 0] + (rho * J * l / 6) * [2, 1; 1, 2]; % Disc at the left end of the element
    else
