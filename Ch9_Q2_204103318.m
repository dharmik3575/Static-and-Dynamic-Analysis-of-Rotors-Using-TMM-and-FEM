...
EI = 2e+6;
E = 2.1e+11;
d = ((EI / E) * 64 / pi)^0.25;        %shaft dia
rho = 7800; % 0 for no shaft mass        %shaft density in kg/m^3
...
connect = [1 1 2;
 ...
 % Boundary conditions    
 bc_data = [1, 1;     % First Column is Node number
            1, 2;
            1, 3;
            1, 4];   % dof 1 for u;2 for phiy; 3 for v; 4 for phix

 mass = [1 0 0 0 0 0; % lumped masses in kg and kg-m^2
         2 8 0 0.001 (pi/6) 0.02;
         3 10 0 0.001 (pi/6) 0.02];  %1st column node, 2nd colum mass, 3rd column Id
...
legend('show');
hold on
saveas(h,'Ch9_Q2_FEM','png');

% print solution
fid = fopen('Ch9_Q2_FEM.txt','w');
