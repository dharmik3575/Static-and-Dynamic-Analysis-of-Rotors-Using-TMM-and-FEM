...
md1 = 10; % in kg
Id1 = 0.04; %md1*D1^2/16; % in kg-m^2

mass = [1,   md1,   Id1];  %1st column node 2nd colum mass 3rd column Id

nele = 2;
connect = [1, 1, 2;
           2, 2, 3];   % First Column is element number
...
bc_data = [3, 1;     % First Column is Node number
           3, 2];     % Second column is prescribed local dof
...
legend('show');
hold on
saveas(h,'Ch8_Q24_FEM','png');

% print solution
fid = fopen('Ch8_Q24_FEM.txt','w');
